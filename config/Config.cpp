...
int parse_config(ConfigClass* config, std::string path)
{
	try {
		...
		config->wordlist_word[0] = access(v, tao::config::key("wordlist_word_1")).get_string();
		config->wordlist_word[1] = access(v, tao::config::key("wordlist_word_2")).get_string();
		config->wordlist_word[2] = access(v, tao::config::key("wordlist_word_3")).get_string();
		config->wordlist_word[3] = access(v, tao::config::key("wordlist_word_4")).get_string();
		config->wordlist_word[4] = access(v, tao::config::key("wordlist_word_5")).get_string();
		config->wordlist_word[5] = access(v, tao::config::key("wordlist_word_6")).get_string();
		config->wordlist_word[6] = access(v, tao::config::key("wordlist_word_7")).get_string();
		config->wordlist_word[7] = access(v, tao::config::key("wordlist_word_8")).get_string();
		config->wordlist_word[8] = access(v, tao::config::key("wordlist_word_9")).get_string();
		config->wordlist_word[9] = access(v, tao::config::key("wordlist_word_10")).get_string();
		config->wordlist_word[10] = access(v, tao::config::key("wordlist_word_11")).get_string();
		config->wordlist_word[11] = access(v, tao::config::key("wordlist_word_12")).get_string();

		//config->wordlist_word_0 = access(v, tao::config::key("wordlist_word_0")).get_array();

		config->rounds_check_validity = (uint32_t)access(v, tao::config::key("cuda_grid")).get_unsigned();
